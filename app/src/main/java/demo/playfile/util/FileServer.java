...
public class FileServer extends Thread implements org.cybergarage.http.HTTPRequestListener {
    ...
    public void httpRequestRecieved(HTTPRequest httpReq) {
        ...
        try {
            String userName = "PC-001";
            String passWord = "jem";
            NtlmPasswordAuthentication mAuthentication = new NtlmPasswordAuthentication("", userName, passWord);
            SmbFile file = new SmbFile(filePaths, mAuthentication);
